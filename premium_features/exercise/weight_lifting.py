...
from premium_features.exercise.go_to_target_page import go_to_run, go_to_weight_lifting
...
def validation_of_duration(driver):
    ...
    for time in time_data["time"]:
        ...
        try:
            ...
            go_to_weight_lifting(driver)  # recover to starting page
...
def check_weight_lifting_page(driver):
    go_to_weight_lifting(driver)
